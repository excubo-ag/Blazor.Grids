...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.Grids -Version 1.2.2
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.Grids --version 1.2.2
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.Grids" Version="1.2.2" />
```

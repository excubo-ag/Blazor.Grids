...
#### Package Manager:
```ps
Install-Package Excubo.Blazor.Grids -Version 1.3.0
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Blazor.Grids --version 1.3.0
```

#### Package Reference
```xml
<PackageReference Include="Excubo.Blazor.Grids" Version="1.3.0" />
```
